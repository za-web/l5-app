...
@section('js')
    ...
    <script src="/pub_admin/js/plugins/morris/raphael.min.js"></script>
    <script src="/pub_admin/js/plugins/morris/morris.min.js"></script>
    <script src="/pub_admin/js/plugins/morris/morris-data.js"></script>
